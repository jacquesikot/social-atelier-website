...
const BookingPage = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    // `duration` comes off a <select> as a string; keep it numeric so the
    // estimated total below is arithmetic rather than string concatenation.
  ...
  const durationLabel =
    selectedSpace?.durationOptions.find((opt) => opt.hours === formData.duration)?.label ||
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    openWhatsApp(
      bookingMessage({
        spaceName: selectedSpace?.name || 'Not specified',
  ...
  // Spell the date out in the WhatsApp message; a raw yyyy-mm-dd is easy to
  // misread when confirming a booking by hand.
    ...
    <div className="bg-neutral-50">
      ...
      >
        ...
        <div className="container-custom relative z-10">
          ...
          >
            Tell us what you need and we'll confirm your reservation over WhatsApp.
          </motion.p>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-neutral-400 text-xs font-light mt-4 max-w-sm leading-relaxed">
                    Your details are formatted into a WhatsApp message so you can review it before sending.
                  </p>
                </div>
              </form>
            </motion.div>
                ...
                <div className="border border-neutral-200 p-6">
                  ...
                  <ol className="space-y-4">
                    {[
                      ...
                      'We confirm availability with you directly',
